...
The interactive Power BI dashboard can be found [here.](https://github.com/AaronMo13/Charity-Shop-Floor-Plan-Optimisation/blob/main/Charity%20Shop%20Dashboard.pbix)

Python notebooks for [data preparation](https://github.com/AaronMo13/Charity-Shop-Floor-Plan-Optimisation/blob/main/Data%20Checks.ipynb), [data tranformation]() and [exploratory data analysis] can be found using these links.
